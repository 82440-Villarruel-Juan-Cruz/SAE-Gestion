...
export async function ObtenerDeportistasXDeporte(id) {
  return RequestAPI(
    "/Deporte/ObtenerDeportistasXDeporte/" + encodeURIComponent(id),
    "GET",
  );
}
...
export async function obtenerTorneosXDeportista(idDeportista) {
  return RequestAPI(
    "/Deporte/ObtenerInscTorneoXDeportista/" + encodeURIComponent(idDeportista),
    "GET",
  );
}
...
export async function obtenerTorneosDeportivos() {
  const torneos = await RequestAPI("/Deporte/ObtenerTorneosDeportivos/", "GET");
...
export async function eliminarInscripcionTorneo(idInscripcion) {
  return RequestAPI(
    "/Deporte/EliminarInscripcionTorneo/" + encodeURIComponent(idInscripcion),
    "DELETE",
  );
}
...
export async function eliminarInscripcionDeporte(idInscripcion) {
  return RequestAPI(
    "/Deporte/EliminarInscripcionDeporte/" + encodeURIComponent(idInscripcion),
    "DELETE",
  );
}
...
export async function eliminarDocumentoEstudiante(id_archivo) {
  return RequestAPI(
    "/Estudiante/EliminarDocumentoEstudiante/" + encodeURIComponent(id_archivo),
    "DELETE",
  );
}
